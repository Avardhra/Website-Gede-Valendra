        ...
        <main className="position w-full min-h-[100vh] p-[3%] sm:px-[4%] md:px-[6%] lg:px-[10%] flex flex-col gap-4">
                <div className="position mt-[6vh] w-full flex flex-col lg:flex-row justify-between items-center text-center lg:text-left">
                        <div className="lg:hidden relative w-full h-fit flex justify-center items-center">
                                <img src="assets/img/gue.png" alt="Gede Valendra" className="w-[60%] md:w-48 md:h-48 lg:w-[50vh] lg:h-[50vh] bg-white rounded-full object-cover shadow-lg" />
                        ...
                        <div className="max-w-[100vh] w-full flex flex-col gap-5 items-center lg:items-start">
                                ...
                                <div className="flex flex-col gap-2">
                                        <p>Hallo, kenalin gua Gede Valendra seorang Mahasiswa aktif Teknik Informatika Institut Teknologi Sumatera.</p>
                        ...
                        <img src="assets/img/gue.png" alt="Gede Valendra" className="hidden lg:block w-32 h-32 md:w-48 md:h-48 lg:w-[50vh] lg:h-[50vh] bg-white rounded-bl-full rounded-tr-[40px] rounded-br-[5px] rounded-tl-[5px] object-cover shadow-lg" />
                </div>
        </main>
    );
}